...
<div class="w-full bg-tdark text-white">
    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <p class="text-5xl leading-normal mb-12">
        ...
        <a href="" class="bg-tyellow px-3 text-xl py-2 uppercase font-black text-tdark inline-block">More about JCal</a>
    </div>
    <div class="max-w-6xl mx-auto px-4">
        ...
        <a href="" class="bg-tred px-3 text-xl py-2 uppercase font-black inline-block">Meet the People of JCal</a>
    </div>
</div>
<?php get_footer();?>